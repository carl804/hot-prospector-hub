...
export function IntakeFormModal({ opportunity, onClose }: IntakeFormModalProps) {
  const form = opportunity.intakeForm;
      ...
      <div className="absolute inset-4 md:inset-8 lg:inset-12 bg-card rounded-xl shadow-2xl overflow-hidden flex flex-col animate-scale-in">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-secondary/30">
          <h2 className="text-xl font-semibold text-foreground">
            Agency Intake Form - {opportunity.agencyName}
          </h2>
        ...
        <div className="flex-1 overflow-y-auto p-6 kanban-scrollbar">
          <Accordion type="multiple" defaultValue={['agency-profile']} className="space-y-2">
            ...
            <AccordionItem value="ghl" className="border border-border rounded-lg px-4">
              ...
              <AccordionContent className="pt-2 pb-4">
                <FieldRow
                  label="GHL Agency Access Ready?"
                  value={<StatusBadge value={form.ghlAgencyAccessReady} />}
                />
                <FieldRow
                  label="Admin Access Given?"
                  value={<StatusBadge value={form.adminAccessGiven} />}
                />
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="platform" className="border border-border rounded-lg px-4">
              ...
              <AccordionContent className="pt-2 pb-4">
                ...
                <FieldRow
                  label="Accepting Payment/SMS Links?"
                  value={<StatusBadge value={form.acceptingPaymentSmsLinks} />}
                />
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="lead-sources" className="border border-border rounded-lg px-4">
              ...
              <AccordionContent className="pt-2 pb-4">
                ...
                <FieldRow
                  label="Include Aged Leads?"
                  value={<StatusBadge value={form.includeAgedLeads} />}
                />
            ...
            <AccordionItem value="twilio" className="border border-border rounded-lg px-4">
              ...
              <AccordionContent className="pt-2 pb-4">
                <FieldRow
                  label="Twilio Account Created?"
                  value={<StatusBadge value={form.twilioAccountCreated} />}
                />
                <FieldRow
                  label="Developer Access Given?"
                  value={<StatusBadge value={form.developerAccessGiven} />}
                />
                <FieldRow
                  label="Primary Business Profile Complete?"
                  value={<StatusBadge value={form.primaryBusinessProfileComplete} />}
                />
                <FieldRow label="Messaging Path" value={form.messagingPath} />
                <FieldRow
                  label="A2P Registration?"
                  value={<StatusBadge value={form.a2pRegistration} />}
                />
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="local-presence" className="border border-border rounded-lg px-4">
              ...
              <AccordionContent className="pt-2 pb-4">
                <FieldRow
                  label="Purchase Matching Area Code Numbers?"
                  value={<StatusBadge value={form.purchaseMatchingAreaCodeNumbers} />}
                />
                <FieldRow
                  label="Outbound Number Count/Location"
                  value={form.outboundNumberCountPerLocation}
                />
            ...
            <AccordionItem value="call-center" className="border border-border rounded-lg px-4">
              ...
              <AccordionContent className="pt-2 pb-4">
                <FieldRow
                  ...
                  value={`${form.numberOfAgentsNow} now / ${form.numberOfAgentsTarget} target (90 days)`}
                />
                ...
                <FieldRow
                  ...
                  value={`${form.attemptsPerLeadLifetime} lifetime / ${form.attemptsPerLeadPerDay} per day`}
                />
                <FieldRow
                  label="Min Hours Between Attempts"
                  value={form.minHoursBetweenAttempts}
                />
                <FieldRow label="Double-Dial?" value={<StatusBadge value={form.doubleDial} />} />
                <FieldRow
                  label="Leave Voicemail?"
                  value={<StatusBadge value={form.leaveVoicemail} />}
                />
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="reporting" className="border border-border rounded-lg px-4">
              ...
              <AccordionContent className="pt-2 pb-4">
                <FieldRow
                  label="Metrics Needing Improvement"
                  value={form.metricsNeedingImprovement}
                />
                <FieldRow
                  label="Conversation Intelligence Setup?"
                  value={<StatusBadge value={form.conversationIntelligenceSetup} />}
                />
                <FieldRow
                  label="AI Summaries in Notes?"
                  value={<StatusBadge value={form.aiSummariesInNotes} />}
                />
                <FieldRow
                  label="Speed to Lead Webhooks?"
                  value={<StatusBadge value={form.speedToLeadWebhooks} />}
                />
                <FieldRow
                  label="Slack Notifications?"
                  value={<StatusBadge value={form.slackNotifications} />}
                />
